...
#else
#define rtw_cfg80211_vendor_event_alloc(wiphy, dev, len, event_id, gfp) \
	cfg80211_vendor_event_alloc(wiphy, dev, len, event_id, gfp)
	...
	struct net_device *dev, int event_id, const void  *data, int len)
{
	...
	skb = rtw_cfg80211_vendor_event_alloc(wiphy, dev->ieee80211_ptr, len, event_id, kflags);
	if (!skb) {
